 ...
 */
class QuizQuestionAddForm extends AbstractForm
{
    /**
     * @inheritDoc
     */
    public $activeMenuItem = 'com.uz.wcf.quiz.QuizPage';
    ...
    public function readFormParameters()
    {
        ...
        if (isset($_POST['correct'])) {
            $this->correct = \intval($_POST['correct']);
        }
    ...
    public function readData()
    {
        ...
        if (MODULE_UZQUIZ) {
            ...
            PageLocationManager::getInstance()->addParentLocation('com.uz.wcf.quiz.QuizQuestionListPage');
        }
    }
