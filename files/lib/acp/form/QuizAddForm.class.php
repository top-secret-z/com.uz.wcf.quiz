...
class QuizAddForm extends AbstractForm
{
    ...
    public function readFormParameters()
    {
        ...
        if (isset($_POST['showResultButton'])) {
            $this->showResultButton = 1;
        }
        if (isset($_POST['showCorrect'])) {
            $this->showCorrect = 1;
        }
        if (isset($_POST['showComment'])) {
            $this->showComment = 1;
        }
        if (isset($_POST['showBest'])) {
            $this->showBest = 1;
        }
        ...
        if (isset($_POST['timeLimit'])) {
            $this->timeLimit = \intval($_POST['timeLimit']);
        }
        if (isset($_POST['points'])) {
            $this->points = \intval($_POST['points']);
        }
        if (isset($_POST['questionIDs'])) {
            $this->questionIDs = StringUtil::trim($_POST['questionIDs']);
        }
        ...
        if (isset($_POST['paused'])) {
            $this->paused = \intval($_POST['paused']);
        }
        if (isset($_POST['randomize'])) {
            $this->randomize = 1;
        }

        if (isset($_POST['assignResult'])) {
            $this->assignResult = \intval($_POST['assignResult']);
        }
        if (isset($_POST['assignGroupIDs']) && \is_array($_POST['assignGroupIDs'])) {
            $this->assignGroupIDs = ArrayUtil::toIntegerArray($_POST['assignGroupIDs']);
        }
