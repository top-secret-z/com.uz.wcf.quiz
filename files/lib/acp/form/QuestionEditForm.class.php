...
class QuestionEditForm extends QuestionAddForm {
	...
	public function save() {
		...
		else I18nHandler::getInstance()->save('question', $this->question, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		...
		else I18nHandler::getInstance()->save('answerOne', $this->answerOne, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		...
		else I18nHandler::getInstance()->save('answerTwo', $this->answerTwo, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		...
		else I18nHandler::getInstance()->save('answerThree', $this->answerThree, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		...
		else I18nHandler::getInstance()->save('answerFour', $this->answerFour, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		...
		else I18nHandler::getInstance()->save('answerFive', $this->answerFive, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		...
		else I18nHandler::getInstance()->save('answerSix', $this->answerSix, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		...
		else I18nHandler::getInstance()->save('comment', $this->comment, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		
		// update question
		// add edit note on edit of user question
		$editedBy = '';
		if (!$this->questionObj->isACP) $editedBy = WCF::getUser()->username;
