...
class QuizEditForm extends QuizAddForm {
	...
	public function readParameters() {
		if (isset($_REQUEST['id'])) $this->quizID = intval($_REQUEST['id']);
	...
	public function save() {
		...
		else I18nHandler::getInstance()->save('text', $this->text, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
		...
		else I18nHandler::getInstance()->save('title', $this->title, 'wcf.acp.quiz', PackageCache::getInstance()->getPackageID('com.uz.wcf.quiz'));
